# Probe Analysis Report (Waves 1, 2, 3, 4)
...
| P14 | hightemp_memory | - | - | - | - | - | - | - | - |
| P15 | seeded_guidance | 13 | 12 | 3 | 1.041 | N/A | 0.333 | 0 | 0.880473 |
| P16 | optimal_baseline | 21 | 20 | 4 | 1.595 | N/A | 0.550 | 0 | 0.962103 |
| P17 | full_stack | 32 | 30 | 5 | 2.030 | 0.600 | 0.500 | 0 | 0.955079 |
| P18 | seeded_parallel | - | - | - | - | - | - | - | - |
...
**agent_0**: 7 runs, categories: data_pipeline, optimization, regularization
...
**agent_0**: 14 runs, categories: architecture, optimization, regularization, other
...
**agent_1**: 15 runs, categories: architecture, data_pipeline, optimization, regularization, other
...
**agent_0**: 21 runs, categories: architecture, data_pipeline, optimization, regularization, other
...
**agent_1**: 23 runs, categories: architecture, data_pipeline, optimization, regularization, other
...
**agent_1**: 35 runs, categories: architecture, optimization, regularization
...
**agent_0**: 13 runs, categories: optimization, regularization, other
  Sequence: other -> optimization -> regularization -> regularization -> optimization -> regularization -> regularization -> regularization -> regularization -> regularization -> regularization -> regularization

### P16: optimal_baseline

**agent_0**: 21 runs, categories: architecture, optimization, regularization, other
  Sequence: regularization -> other -> optimization -> optimization -> other -> architecture -> regularization -> regularization -> regularization -> optimization -> optimization -> regularization -> optimization -> optimization -> regularization -> regularization -> regularization -> regularization -> optimization -> optimization

### P17: full_stack

**agent_0**: 4 runs, categories: architecture, regularization, other
  Sequence: other -> regularization -> architecture
**agent_1**: 28 runs, categories: architecture, data_pipeline, optimization, regularization, other
  Sequence: other -> other -> other -> other -> optimization -> optimization -> optimization -> optimization -> optimization -> other -> data_pipeline -> regularization -> data_pipeline -> optimization -> optimization -> other -> other -> optimization -> optimization -> other -> optimization -> architecture -> architecture -> architecture -> regularization -> optimization -> optimization
...
CROSS-PROBE SUMMARY:
  ...
  P15 (W4): runs=13, entropy=1.041, improvements=0, best_bpb=0.880473, score=18.2
  P16 (W4): runs=21, entropy=1.595, improvements=0, best_bpb=0.962103, score=29.0
  P17 (W4): runs=32, entropy=2.030, improvements=0, best_bpb=0.955079, score=42.2
...
| Category | Count | % |
|----------|-------|---|
| optimization | 127 | 45.7% |
| regularization | 81 | 29.1% |
| other | 48 | 17.3% |
| architecture | 15 | 5.4% |
| data_pipeline | 7 | 2.5% |
